...
def view_log_6():
    ...
    # Tạo DataFrame với các cột hợp lệ, tránh trùng lặp
    valid_columns = ['run_id'] + [col for col in expected_columns if col in runs.columns]  # Chỉ thêm 'run_id', không thêm 'params.log_time' nữa
